...
class RegisterController extends BaseController
{
	...
	{
		return View::make('patient.register');
	}
	public function registerCreate()
	{
		...
		if ($validator->passes()) { $addUser = new User();
			...
			$addUser->status = 'A';
			$addUser->save();
			return Redirect::to('login/registerPatient')->with('flash_notice','ดำเนินการสำเร็จ');}
		else{return Redirect::to('login/registerPatient')->withErrors($validator)
