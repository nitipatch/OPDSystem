<?php
    ...
    echo '<tr>
            	<td style="text-align:left;" valign="top">
                    <label>ค้นหารหัสโรค ICD-10 ด้วยชื่อโรค<font color="red">*</font></label></td>
                <td>
    ...
    echo  '<tr><td><input value='.' id=d-'.$c.'-2 type="hidden" name="D['.$c.'][2]"></td></tr>';
    echo  '<tr><td><input value='.' id=d-'.$c.'-3 type="hidden" name="D['.$c.'][3]"></td></tr>';
    echo  '<tr><td><input value='.' id=d-'.$c.'-4 type="hidden" name="D['.$c.'][4]"></td></tr>';
    echo  '<tr><td><input value='.' id=d-'.$c.'-5 type="hidden" name="D['.$c.'][5]"></td></tr>';
