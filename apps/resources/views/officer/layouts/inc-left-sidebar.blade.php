...
-->
	...
	<li><a href="logout"><i class="fa fa-unlock fa-fw"></i>ค้นหาผู้ป่วย</a></li>
	<li><a href="logout"><i class="fa fa-unlock fa-fw"></i>นำเข้าตารางออกตรวจ</a></li>
	<li><a href="logout"><i class="fa fa-unlock fa-fw"></i>ดูรายชื่อแพทย์ออกตรวจ</a></li>
